...
public class Public extends Fragment  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.public_add, container, false);
        userId=user.getUid();
        mRoot= FirebaseDatabase.getInstance().getReference().child("Users").child(userId).child("profile").child("public");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //show modal
                modalAppPub fragment = new modalAppPub();
