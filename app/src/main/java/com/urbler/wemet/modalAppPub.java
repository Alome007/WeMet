...
public class modalAppPub extends BottomSheetDialogFragment {
    ...
    public void setupDialog(final Dialog dialog, final int style) {
        ...
        view= LayoutInflater.from(getContext()).inflate(R.layout.add_pub, null);
    ...
    private void UploadToFirebase(String title,String value) {
        ...
        if (userId != null) {
            DatabaseReference mData= FirebaseDatabase.getInstance().getReference().child("Users").child(userId).child("profile").child("public").push();
            publicData priData=new publicData(title,value,userId);
